...
namespace EPortalAdmin.Application.Features.OperationClaims.Queries
{
    ...
    {
        public class GetQueryableOperationClaimsQueryQueryHandler : ApplicationFeatureBase<OperationClaim>,
            IRequestHandler<GetQueryableOperationClaimsQuery, IQueryable<OperationClaimDto>>
        {
