...
namespace EPortalAdmin.Core.Mailing.MailKit
{
    public class MailKitMailService(IConfiguration configuration) : IMailService
    {
        private readonly MailSettings _mailSettings =
                configuration.GetSection(MailSettings.AppSettingsKey).Get<MailSettings>()
                    ?? MailSettings.Default;
        private DkimSigner? _signer = null;
